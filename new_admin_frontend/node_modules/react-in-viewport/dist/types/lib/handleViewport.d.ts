...
declare function handleViewport<TElement extends HTMLElement, TProps extends InjectedViewportProps<TElement>>(TargetComponent: ComponentType<TProps>, options?: Options, config?: Config): {
